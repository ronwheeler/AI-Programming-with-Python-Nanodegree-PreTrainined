...
# TODO 2: Define get_pet_labels function belowplease be certain to replace None
...
def get_pet_labels(image_dir):
    ...
    # items_in_file = len(filename_list)
    print("\nNumber of items in File - n items=", len(filename_list)) #40
    
   
    pet_labels = list()
    
    # loop through filename_list
    for idx in range(0, len(filename_list), 1):
