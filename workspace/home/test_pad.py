...
for key in results_dic:
    ...
    if sum(results_dic[key][3:]) == 0 and results_dic[key][2] == 1:
        print("*NOT-a-Dog Match*")
          ...
          truth = results_dic[key][0] # I can't seem to change this iterator
            print ("truth = ", truth)
            .
            .
            .
          if truth in model_label:
            print(truth) ### always is cat...
            pet_label_is_dog = [model_label, 1, 1]
            # extend with classifier_label (model_label)
            results_dic[filenames[idx]].extend(pet_label_is_dog)
