...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    print("Entering results_dic in adjust_results4_isadog file....")
    for key in results_dic:
        print()
        print()
        
        # print ('Key:{}, Value:{}'.format(key, results_dic[key]))
    ...
    # print ("printing updated results...")
    for key in results_dic:
        
        print (key, results_dic[key][0], results_dic[key][1], results_dic[key][2], results_dic[key][3])
