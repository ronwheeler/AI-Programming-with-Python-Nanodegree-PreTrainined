...
def calculates_results_stats(results_dic):
    ...
    * example_dictionary = {'Beagle_01141.jpg': ['beagle', 'walker hound, walker foxhound', 0, 1, 1]}
    ...
    for key in results_dic:
        ...
        if results_dic[key][2] == 1: # index 2 = 0/1 where 1 = labels match , 0 = labels don't match (ex: 0) ### Y optional
            results_stats_dic['n_match'] += 1
        
        # A
        # Number of Dog matches #### A 
        ...
        if results_dic[key][3] == 1: # index 3 = 0/1 where 1= Pet Image Label is a dog, 0 = Pet Image Label isn't a dog (ex: 1)
    ...
    # if results_dic[key][4] == 1: # index 4 = 0/1 where 1= Classifier Label is a dog, 0 = Classifier Label isn't a dog (ex: 1)
        # results_stats_dic['n_correct_dogs'] += 1
    
    
    # Obj 1a
    # pct of correctly classified dog images
    results_stats_dic['pct_correct_dogs'] = 100.0*(results_stats_dic['n_correct_dogs'] / results_stats_dic['n_dogs_img'])
    
    # Obj 1b
    # pct of correctly classified non-dog images
    ...
    #Obj 2
    # pct of correctly classified dog breeds
